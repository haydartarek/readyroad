...
# Configuration
INPUT_FILE = Path(__file__).parent / "quiz_questions_generated.json"
OUTPUT_FILE = Path(__file__).parent.parent / "src" / "main" / "resources" / "db" / "migration" / "V8__Add_Quiz_Questions.sql"
