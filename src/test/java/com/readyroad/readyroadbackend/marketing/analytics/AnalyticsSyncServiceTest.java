...
import com.readyroad.readyroadbackend.marketing.editorial.EditorialPerformanceTaskService;
...
class AnalyticsSyncServiceTest {
    ...
    private final EditorialPerformanceTaskService editorialPerformance =
            mock(EditorialPerformanceTaskService.class);
    ...
    private final AnalyticsSyncService service = new AnalyticsSyncService(
            ...
            editorialOpportunities, editorialPerformance,
    ...
    void bothGoogleSourcesFailWithRetryableSourceFailure() {
        ...
        verifyNoInteractions(editorialPerformance);
    }
}
