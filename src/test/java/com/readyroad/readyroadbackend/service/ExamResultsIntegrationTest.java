...
class ExamResultsIntegrationTest extends BaseIntegrationTest {
    ...
    void testGetExamResultsForCompletedExam() {
        ...
        // ✅ Fixed: Explanation is optional in BaseIntegrationTest seeded questions
        // Some questions may not have explanations, which is valid
        var firstIncorrectQuestion = results.getIncorrectQuestions().get(0);
        if (firstIncorrectQuestion.getExplanationEn() != null) {
            assertThat(firstIncorrectQuestion.getExplanationEn()).isNotEmpty();
        }
    }
