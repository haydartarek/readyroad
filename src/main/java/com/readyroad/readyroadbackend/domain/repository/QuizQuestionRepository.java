...
public interface QuizQuestionRepository extends JpaRepository<QuizQuestion, Long>, QuizQuestionRandomRepository {
        ...
        /** Count every Admin-managed question in one difficulty tier. */
        long countByDifficultyLevel(QuizQuestion.DifficultyLevel difficultyLevel);

        /** Count Admin-managed questions that have not yet been classified. */
        long countByDifficultyLevelIsNull();
