...
/**
 * Per-question result returned after checking a Belgian theory exam (practice mode).
 * Includes multilingual question text, the correct option, and the user's selected option.
 */
@Data
@Builder
@NoArgsConstructor
