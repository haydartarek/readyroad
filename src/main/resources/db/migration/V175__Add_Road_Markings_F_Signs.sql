...
(
    ...
    'تشير هذه الإشارة المرورية إلى وجود تحويلة مؤقتة يجب اتباعها بسبب أعمال الطرق أو وجود عائق على الطريق. السهم يشير إلى اتجاه التحويل. وقد يشير النص إلى استثناء لمركبات معينة مثل وسائل النقل العام أو المركبات الثقيلة. يجب على جميع السائقين الآخرين اتباع التحويل حتى اكتمال الأعمال أو إعطاء تعليمات أخرى.'
),
...
(
    ...
    'تشير هذه الإشارة المرورية المؤقتة إلى أن المسار المحجوز على الجانب الأيسر من الطريق سوف يصبح متاحاً مرة أخرى بعد 1500 متر. تستخدم هذه العلامة للإشارة إلى توسيع الطريق.'
),
...
(
    ...
    'تشير هذه الإشارة المرورية المؤقتة إلى وجود انحراف أو تحويل للطريق في الأمام. يتم تحذير السائقين مسبقاً حتى يتمكنوا من الاستعداد لاتباع مسار الانحراف المحدد.'
),
...
(
    ...
    'تشير هذه الإشارة المرورية المؤقتة إلى أن العائق المؤقت على الطريق (مثل الحواجز أو أعمال الطرق) سينتهي وسيعاد فتح المسار المغلق بعد 1500 متر. تشير هذه العلامة إلى نهاية المنطقة المحظورة أو المغلقة.'
),
...
(
    ...
    'تحذر هذه الإشارة المرورية المؤقتة من أن المسار الأيسر سوف يختفي بعد مسافة معينة (1500 متر). يجب على السائقين في هذا المسار التحرك إلى اليمين. تُستخدم هذه العلامة في مناطق العمل المؤقتة لتوجيه حركة المرور بشكل آمن.'
),
...
(
    ...
    'هذه الإشارة المرورية لها نفس غرض F91، ولكنها تستخدم لتحذير السائقين مسبقاً من أن السرعات المختلفة لكل حارة سيتم تطبيقها بعد 1500 متر. يعطي الوقت لتغيير المسارات إذا لزم الأمر.'
),
...
(
    ...
    'تشير هذه الإشارة المرورية إلى السرعة القصوى في كل حارة من الطريق، مثلاً الحارة اليسرى 70 كم/ساعة، الوسطى 90 كم/ساعة وهكذا. يتم استخدامه على الطرق السريعة متعددة المسارات لتنظيم تدفق حركة المرور.'
),
...
(
    ...
    'تشير هذه الإشارة المرورية إلى مخرج يؤدي إلى منطقة خدمة على الطريق السريع، مثل محطة وقود أو منطقة استراحة. يوضح الخط الجانبي اتجاه الانحراف نحو الطريق الجانبي.'
),
...
(
    ...
    'تقوم هذه الإشارة المرورية بتوجيه السائق إلى منطقة طوارئ مخصصة على جانب الطريق السريع، مثلاً للتوقف في حالة حدوث عطل ميكانيكي أو طلب المساعدة. يستخدم فقط في حالات الطوارئ.'
);
