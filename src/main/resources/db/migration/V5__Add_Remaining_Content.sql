...
VALUES
    ...
    (10, 'ما هو قرص الوقوف؟', 'What is parking disc?', 'Wat is parkeerschijf?', 'Qu''est-ce que disque de stationnement?',
     ...
     'قرص يوضح وقت الوصول', 'Disc showing arrival time', 'Schijf die aankomsttijd toont', 'Disque montrant heure arrivée',
     'جهاز دفع', 'Payment device', 'Betaalapparaat', 'Appareil paiement',
     3, 'قرص الوقوف أداة توضح وقت وصولك ويجب عرضها في المناطق الزرقاء', 'Parking disc is tool showing arrival time must be displayed in blue zones', 'Parkeerschijf is hulpmiddel dat aankomsttijd toont en moet worden getoond in blauwe zones', 'Disque stationnement est outil montrant heure arrivée doit être affiché en zones bleues',
     5, TRUE, NOW(), NOW());
...
-- ============================================================================
-- ADDITIONAL EXAM QUESTIONS - Pattern-Based (Belgian Exam Style)
-- ============================================================================
-- Following 10 real Belgian exam patterns: short, trap options, single rule focus
...
VALUES
    -- Pattern 2: Visual Recognition (EASY)
    (1, 'مثلث أحمر بحدود، ما لونه؟', 'Red triangle with border, what color?', 'Rode driehoek met rand, welke kleur?', 'Triangle rouge avec bordure, quelle couleur?',
     ...
     2, 'إشارات التحذير: أحمر على أبيض', 'Warning signs: red on white', 'Waarschuwingsborden: rood op wit', 'Panneaux avertissement: rouge sur blanc',
     'EASY', TRUE, TRUE, NOW(), NOW());

-- For production: Add more pattern-based questions for all categories
-- This file demonstrates the Belgian exam structure.
