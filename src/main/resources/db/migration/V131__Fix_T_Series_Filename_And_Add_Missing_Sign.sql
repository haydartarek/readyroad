...
VALUES (
    ...
    'تشير هذه الإشارة المرورية إلى وجود عائق أو تضييق على جانب الطريق، ويجب على السائق المرور على الجانب الأيسر حسب اتجاه الخطوط القطرية. يتم استخدامه غالبًا في أعمال الطرق أو الحواجز الثابتة على الجانب الأيمن، ويجب عليك إبطاء السرعة واتباع الاتجاه المشار إليه بدقة لتجنب الاصطدام.',
