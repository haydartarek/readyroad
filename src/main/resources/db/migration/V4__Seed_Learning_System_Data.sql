...
VALUES
    -- Q1: Warning Sign
    (1, 'عند رؤية إشارة تحذير بمنعطف خطير، ما هو التصرف الصحيح؟', 'When seeing a warning sign for dangerous bend, what is the correct action?', 'Wat is de juiste actie bij het zien van een waarschuwingsbord voor gevaarlijke bocht?', 'Quelle est l''action correcte en voyant un panneau d''avertissement de virage dangereux?',
     'تخفيف السرعة والاستعداد', 'Reduce speed and prepare', 'Snelheid verminderen en voorbereiden', 'Réduire la vitesse et se préparer',
     'زيادة السرعة للمرور سريعاً', 'Increase speed to pass quickly', 'Snelheid verhogen om snel te passeren', 'Augmenter la vitesse pour passer rapidement',
     'التوقف تماماً', 'Stop completely', 'Volledig stoppen', 'Arrêter complètement',
     'التجاوز قبل المنعطف', 'Overtake before bend', 'Inhalen voor de bocht', 'Dépasser avant le virage',
     1, 'يجب تخفيف السرعة والاستعداد للخطر المحتمل', 'Must reduce speed and prepare for potential danger', 'Moet snelheid verminderen en voorbereiden op mogelijk gevaar', 'Doit réduire la vitesse et se préparer au danger potentiel',
     NULL, 'MEDIUM', TRUE, TRUE, NOW(), NOW()),
     
    -- Q2: Priority Sign
    (2, 'في تقاطع مع إشارة "أعط الأولوية"، من يمر أولاً؟', 'At intersection with "Give Way" sign, who goes first?', 'Bij kruispunt met "Voorrang verlenen" bord, wie gaat eerst?', 'À l''intersection avec panneau "Céder le passage", qui passe en premier?',
     'المركبات على الطريق الرئيسي', 'Vehicles on main road', 'Voertuigen op hoofdweg', 'Véhicules sur route principale',
     'أنا دائماً', 'Me always', 'Ik altijd', 'Moi toujours',
     'من يصل أولاً', 'Who arrives first', 'Wie eerst aankomt', 'Qui arrive en premier',
     'المركبات الأكبر', 'Larger vehicles', 'Grotere voertuigen', 'Véhicules plus grands',
     1, 'عند إشارة أعط الأولوية، المركبات على الطريق الرئيسي لها الأولوية', 'At Give Way sign, vehicles on main road have priority', 'Bij Voorrang verlenen bord hebben voertuigen op hoofdweg voorrang', 'Au panneau Céder le passage, véhicules sur route principale ont priorité',
     NULL, 'EASY', TRUE, TRUE, NOW(), NOW()),
     
    -- Q3: Prohibition
    (3, 'ماذا يحدث إذا دخلت منطقة ممنوع الدخول؟', 'What happens if you enter a no-entry zone?', 'Wat gebeurt er als je een verboden toegang zone binnenrijdt?', 'Que se passe-t-il si vous entrez dans une zone d''accès interdit?',
     'مخالفة وغرامة', 'Violation and fine', 'Overtreding en boete', 'Infraction et amende',
     'لا شيء', 'Nothing', 'Niets', 'Rien',
     'تحذير فقط', 'Warning only', 'Alleen waarschuwing', 'Avertissement seulement',
     'نقاط على الرخصة', 'Points on license', 'Punten op rijbewijs', 'Points sur permis',
     1, 'دخول منطقة ممنوع الدخول يؤدي لمخالفة وغرامة', 'Entering no-entry zone leads to violation and fine', 'Binnenrijden in verboden toegang zone leidt tot overtreding en boete', 'Entrer dans zone d''accès interdit conduit à infraction et amende',
     NULL, 'EASY', TRUE, TRUE, NOW(), NOW()),
     
    -- Q4: Mandatory
    (4, 'ما الفرق بين الإشارة الزرقاء والحمراء؟', 'What is the difference between blue and red signs?', 'Wat is het verschil tussen blauwe en rode borden?', 'Quelle est la différence entre panneaux bleus et rouges?',
     'الأزرق إلزام والأحمر منع', 'Blue is mandatory, red is prohibition', 'Blauw is verplicht, rood is verbod', 'Bleu est obligatoire, rouge est interdiction',
     'الأحمر إلزام والأزرق منع', 'Red is mandatory, blue is prohibition', 'Rood is verplicht, blauw is verbod', 'Rouge est obligatoire, bleu est interdiction',
     'نفس المعنى', 'Same meaning', 'Zelfde betekenis', 'Même signification',
     'الأزرق للطرق السريعة فقط', 'Blue for highways only', 'Blauw alleen voor snelwegen', 'Bleu pour autoroutes seulement',
     1, 'الدائرة الزرقاء تعني إلزام، والحمراء تعني منع', 'Blue circle means mandatory, red means prohibition', 'Blauwe cirkel betekent verplicht, rood betekent verbod', 'Cercle bleu signifie obligatoire, rouge signifie interdiction',
     NULL, 'MEDIUM', TRUE, TRUE, NOW(), NOW()),
     
    -- Q5: Parking
    (5, 'هل يمكنك الانتظار في منطقة ممنوع الانتظار لشراء شيء سريع؟', 'Can you park in no-parking zone to buy something quickly?', 'Mag je parkeren in parkeerverbod zone om snel iets te kopen?', 'Pouvez-vous stationner dans zone de stationnement interdit pour acheter rapidement?',
     'لا، ممنوع الانتظار', 'No, parking forbidden', 'Nee, parkeren verboden', 'Non, stationnement interdit',
     'نعم، لمدة 5 دقائق', 'Yes, for 5 minutes', 'Ja, voor 5 minuten', 'Oui, pour 5 minutes',
     'نعم، إذا وضعت الإشارات', 'Yes, if hazard lights on', 'Ja, als alarmlichten aan', 'Oui, si feux de détresse',
     'نعم، في الليل فقط', 'Yes, at night only', 'Ja, alleen \'s nachts', 'Oui, seulement la nuit',
     1, 'في منطقة ممنوع الانتظار، الانتظار ممنوع تماماً', 'In no-parking zone, parking is completely forbidden', 'In parkeerverbod zone is parkeren volledig verboden', 'Dans zone de stationnement interdit, stationnement complètement interdit',
     NULL, 'MEDIUM', TRUE, TRUE, NOW(), NOW()),
     
    -- Q6: Direction
    (6, 'أنت على طريق سريع وترى إشارة خضراء للمخرج، متى يجب أن تغير الحارة؟', 'You are on highway and see green exit sign, when should you change lane?', 'Je bent op snelweg en ziet groen afritbord, wanneer moet je van rijstrook wisselen?', 'Vous êtes sur autoroute et voyez panneau de sortie vert, quand devez-vous changer de voie?',
     'مسبقاً وبهدوء', 'In advance and calmly', 'Vooraf en kalm', 'À l''avance et calmement',
     'في اللحظة الأخيرة', 'At last moment', 'Op het laatste moment', 'Au dernier moment',
     'بسرعة عند المخرج', 'Quickly at exit', 'Snel bij de afrit', 'Rapidement à la sortie',
     'ليس ضرورياً', 'Not necessary', 'Niet nodig', 'Pas nécessaire',
     1, 'يجب تغيير الحارة مسبقاً وبهدوء لضمان السلامة', 'Must change lane in advance and calmly for safety', 'Moet vooraf en kalm van rijstrook wisselen voor veiligheid', 'Doit changer de voie à l''avance et calmement pour sécurité',
     NULL, 'MEDIUM', TRUE, TRUE, NOW(), NOW()),
     
    -- Q7: Additional
    (7, 'لوحة إضافية تقول "إلا الدراجات"، ماذا تعني؟', 'Additional plate says "Except bicycles", what does it mean?', 'Aanvullend bord zegt "Uitgezonderd fietsen", wat betekent het?', 'Panneau additionnel dit "Sauf vélos", que signifie-t-il?',
     'الإشارة لا تنطبق على الدراجات', 'Sign does not apply to bicycles', 'Bord geldt niet voor fietsen', 'Panneau ne s''applique pas aux vélos',
     'ممنوع على الدراجات فقط', 'Forbidden for bicycles only', 'Alleen verboden voor fietsen', 'Interdit aux vélos seulement',
     'الدراجات لها طريق خاص', 'Bicycles have special road', 'Fietsen hebben speciale weg', 'Vélos ont route spéciale',
     'يجب أن تتوقف الدراجات', 'Bicycles must stop', 'Fietsen moeten stoppen', 'Vélos doivent s''arrêter',
     1, 'اللوحة الإضافية "إلا" تعني استثناء من الإشارة الرئيسية', 'Additional plate "Except" means exception from main sign', 'Aanvullend bord "Uitgezonderd" betekent uitzondering van hoofdbord', 'Panneau additionnel "Sauf" signifie exception du panneau principal',
     NULL, 'HARD', TRUE, TRUE, NOW(), NOW()),
     
    -- Q8: Mixed - Speed and Safety
    (3, 'ما هي السرعة القصوى في منطقة سكنية بدون إشارات؟', 'What is maximum speed in residential area without signs?', 'Wat is de maximumsnelheid in woongebied zonder borden?', 'Quelle est la vitesse maximale en zone résidentielle sans panneaux?',
     '50 كم/ساعة', '50 km/h', '50 km/u', '50 km/h',
     '30 كم/ساعة', '30 km/h', '30 km/u', '30 km/h',
     '70 كم/ساعة', '70 km/h', '70 km/u', '70 km/h',
     '90 كم/ساعة', '90 km/h', '90 km/u', '90 km/h',
     1, 'السرعة القصوى الافتراضية في المناطق السكنية 50 كم/ساعة', 'Default maximum speed in residential areas is 50 km/h', 'Standaard maximumsnelheid in woongebieden is 50 km/u', 'Vitesse maximale par défaut en zones résidentielles est 50 km/h',
     NULL, 'EASY', TRUE, TRUE, NOW(), NOW()),
     
    -- Q9: Mixed - Right of Way
    (2, 'عند دوار بدون إشارات، من له الأولوية؟', 'At roundabout without signs, who has priority?', 'Bij rotonde zonder borden, wie heeft voorrang?', 'Au rond-point sans panneaux, qui a priorité?',
     'من في الدوار', 'Who is in roundabout', 'Wie in rotonde is', 'Qui est dans rond-point',
     'من يدخل الدوار', 'Who enters roundabout', 'Wie rotonde binnenrijdt', 'Qui entre rond-point',
     'من اليمين', 'From right', 'Van rechts', 'De droite',
     'الأكبر حجماً', 'Larger vehicle', 'Groter voertuig', 'Véhicule plus grand',
     1, 'في الدوار، من في الدائرة له الأولوية دائماً', 'At roundabout, who is in circle always has priority', 'Bij rotonde heeft wie in cirkel is altijd voorrang', 'Au rond-point, qui est dans cercle a toujours priorité',
     NULL, 'MEDIUM', TRUE, TRUE, NOW(), NOW()),
     
    -- Q10: Mixed - Night Driving
    (1, 'متى يجب استخدام الأضواء العالية؟', 'When should you use high beams?', 'Wanneer moet je grootlicht gebruiken?', 'Quand devez-vous utiliser feux de route?',
     'على طرق مظلمة بدون مركبات مقابلة', 'On dark roads without oncoming vehicles', 'Op donkere wegen zonder tegemoetkomend verkeer', 'Sur routes sombres sans véhicules venant en sens inverse',
     'دائماً في الليل', 'Always at night', 'Altijd \'s nachts', 'Toujours la nuit',
     'في المدينة فقط', 'In city only', 'Alleen in stad', 'En ville seulement',
     'عند المطر', 'When raining', 'Bij regen', 'Quand il pleut',
