...
--       Fix historical A33 image_path in road_signs
-- =============================================================================
...
-- A33 road_signs image_path still needs the canonical danger_signs path.
-- =============================================================================
...
-- ─────────────────────────────────────────────────────────────────────────────
-- SECTION 3: road_signs — enforce canonical A33 image_path
-- Historical duplicate path removed
-- Canonical path: images/signs/danger_signs/A33 Verkeerslichten.png
-- ─────────────────────────────────────────────────────────────────────────────
UPDATE road_signs
SET    image_path  = 'images/signs/danger_signs/A33 Verkeerslichten.png',
       updated_at  = NOW()
WHERE  sign_code = 'A33';
