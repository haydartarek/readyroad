...
VALUES
    ...
    (7, 'G1', 'مسافة السريان', 'Distance', 'Afstand', 'Distance', 'يوضح مسافة سريان الإشارة', 'Indicates distance of sign validity', 'Geeft afstand van borgeldigheid aan', 'Indique la distance de validité du panneau', NULL, TRUE, NOW(), NOW()),
